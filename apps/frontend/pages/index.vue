<template>
    <NuxtLayout name="dashboard">
        <div class="flex flex-col h-full gap-3 p-3 md:p-6">
            <div class="flex shrink-0 gap-2 overflow-auto" v-show="state.games">
            ...
            <div class="grid flex-1 grid-cols-[repeat(auto-fill,_minmax(300px,_1fr))] auto-rows-min gap-2" v-show="state.rooms">
